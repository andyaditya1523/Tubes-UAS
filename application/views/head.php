...
<html>
<head>
  <title>Satkes Instansi XYZ</title>
  ...
  <div class="navbar navbar-inverse navbar-fixed-top">
    <div class="container">
      <div class="navbar-header">
        ...
        <?php echo anchor('depan','<i class="glyphicon glyphicon-plus"></i> Satkes Instansi XYZ',array('class'=>'navbar-brand'));?>
      </div>
      ...
      <ul class="nav navbar-nav navbar-right">
		<?php 
			...
			{
				$_sesion_role = $this->session->userdata('role');
			}
		?>
        <li><a href="#">Hai, <?php echo $this->session->userdata('namalengkap');?> (<?php echo $_sesion_role;?>)</a></li>
        <li class="dropdown">
